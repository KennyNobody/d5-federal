...
$(document).ready(function(){$(".info__slider").owlCarousel({items:1,URLhashListener:!0,autoplayHoverPause:!0,dots:!0,navContainer:".info__slider",loop:!0,nav:!0,navText:['<svg class="icon-svg icon-slider-arrow"><use xlink:href="#icon-svg-slider-arrow"></use></svg>','<svg class="icon-svg icon-slider-arrow"><use xlink:href="#icon-svg-slider-arrow"></use></svg>']}),$(".header__dropdown-visible").customScroll({vertical:!0,horizontal:!1}),$(".info__question").owlCarousel({items:1,URLhashListener:!0,autoplayHoverPause:!0,dots:!1,loop:!0,nav:!1,animateOut:"fadeOut"});var e=$(".info__question");e.owlCarousel(),$(".slider__next").click(function(){e.trigger("next.owl.carousel")}),$(".slider__prev").click(function(){e.trigger("prev.owl.carousel",[300])}),$(".video__slider").owlCarousel({items:1,URLhashListener:!0,autoplayHoverPause:!0,dots:!1,loop:!0,autoHeight:!0,nav:!1});var i=$(".video__slider");e.owlCarousel(),$(".video__btn-right").click(function(){i.trigger("next.owl.carousel")}),$(".video__btn-left").click(function(){i.trigger("prev.owl.carousel",[300])}),$(".single__slider").each(function(){$(this).owlCarousel({items:1,dots:!0,nav:!0,loop:!0,nav:!0,navText:['<svg class="icon-svg icon-slider-arrow"><use xlink:href="#icon-svg-slider-arrow"></use></svg>','<svg class="icon-svg icon-slider-arrow"><use xlink:href="#icon-svg-slider-arrow"></use></svg>']})}),$(".popup").magnificPopup(),$(".info__present ").click(function(){$(this).parent(this).parent(this).parent(this).toggleClass("info__question--open")}),$("#my-menu").mmenu({navbar:{title:"<p>Держи пять!</p>"},extensions:{all:["theme-white","pagedim-black","border-none","fx-menu-slide"],"(min-height: 600px)":["listview-large"],"(min-height: 900px)":["listview-huge"]}},{offCanvas:{pageSelector:"#page"}}),$(".autoscroll").on("click",function(e){$("html,body").stop().animate({scrollTop:$(this.hash).offset().top},1e3),e.preventDefault()}),$(".about .question__btn").on("click",function(){var e=$(".header").height(),i=$(".content__header-bg").height();window.scrollTo(e+i,e+i)}),$(window).on("load resize",function(){if(!($(window).width()<="980"))return!1;var e=754/469;$(".info__slider").height($(".info__slider").width()/e),$(".info__slider .owl-item").height($(".info__slide").width()/e),$(".video__block").height($(".video__block").width()/(912/642))}),$(document).on("click",".video__btn-play--3",function(){var e=$("#main-video-3"),i=e.attr("src");e.attr("src",i+"&autoplay=1"),$(".video__block-play--3").fadeOut("slow",function(){$(".video__block-play--3").css({display:"none"})})}),$(document).on("click",".video__btn-play--1",function(){var e=$("#main-video-1"),i=e.attr("src");e.attr("src",i+"&autoplay=1"),$(".video__block-play--1").fadeOut("slow",function(){$(".video__block-play--1").css({display:"none"})})}),$(document).on("click",".video__btn-play--2",function(){var e=$("#main-video-2"),i=e.attr("src");e.attr("src",i+"&autoplay=1"),$(".video__block-play--2").fadeOut("slow",function(){$(".video__block-play--2").css({display:"none"})})}),$("#spinner").spinner("delay",200).spinner("changed",function(e,i,t){}).spinner("changing",function(e,i,t){}),$(".header__city--link-drop").mouseup(function(){$(".header__dropdown").hasClass("header__dropdown--hidden")?($(".header__dropdown").removeClass("header__dropdown--hidden"),$(".header__dropdown").css({visibility:"visible"})):($(".header__dropdown").addClass("header__dropdown--hidden"),$(".header__dropdown").css({visibility:"hidden"}))}),$("body").click(function(e){0===$(e.target).closest(".header__dropdown").length&&0===$(e.target).closest(".header__city--link-drop").length&&($(".header__dropdown").addClass("header__dropdown--hidden"),$(".header__dropdown").css({visibility:"hidden"}))}),$(".single__column--right").magnificPopup({delegate:"a",type:"image",tLoading:"Загрузка изображения...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]},image:{tError:'<a href="%url%">Изображение не может быть загружно.',titleSrc:function(e){return e.el.attr("title")}}}),$(".question__label").click(function(){$(this).parent().find(".question__label").removeClass("question__label--selected"),$(this).addClass("question__label--selected")}),$("#datepicker input").datepicker({firstDay:1,dateFormat:"dd-mm-yy",beforeShow:function(e,i){var t=$(this).offset(),n=t.top,s=t.left;$(this).outerWidth();console.log("top: "+n+"left: "+s),setTimeout(function(){i.dpDiv.css({top:n,left:s})},0)}}),$(".radio input").change(function(){$(this).parent().toggleClass("radio--active"),console.log("привет"),$(this).parent().hasClass("radio--active")?(console.log("Отмечено"),$(this).parent().find(".radio__btn").text("Нет")):(console.log("Снято"),$(this).parent().find(".radio__btn").text("Да"))}),$(".rateYo").rateYo({fullStar:!0,starWidth:"19px",rating:0,spacing:"6px",multiColor:{startColor:"#00bcc9",endColor:"#00FF00"}}),$(".rateYo").click(function(){var e=$(this).rateYo().rateYo("rating");$(this).parent().find("input").val(e)}),$(".question__btn--no").click(function(){$("#question__work-with-work").css({display:"block"}),$("#question__btn-start").css({display:"flex"}),$(".hide-in-start").css({display:"none"}),$(".question__btn--no").css({display:"none"}),$(".question__btn--yes").css({display:"none"}),$(".question__city").css({display:"block"}),$(".question__city-discript").css({display:"none"}),$(".question__city ul").css({display:"none"}),$(".question__info").css({display:"none"})}),$(".question__btn--yes").click(function(){$(".question__city").css({display:"block"}),$(".question__btn--no").css({display:"none"}),$(this).css({display:"none"}),$(".hide-in-start").css({display:"none"})}),$(".question__btn-city-yes").click(function(){$(".question__answer-yes").css({display:"block"}),$(".question__city-discript").css({display:"none"}),$(".question__city ul").css({display:"none"}),$(".question__info").css({display:"none"}),$("#question__btn-start").css({display:"flex"})}),$(".question__btn-city-no").click(function(){$("#question__work-with-work").css({display:"none"}),$(".question__city-discript--bottom").css({display:"block"}),$(".question__city ul").css({display:"none"}),$(".question__info").css({display:"none"}),$("#question__btn-start").css({display:"flex"})}),$("#question__btn-start").click(function(){$(".question").css({display:"none"}),$(this).parent().parent().next(".question").css({display:"block"})}),$(".question__btn--next").click(function(){$(".question").css({display:"none"}),$(this).parent().next(".question").css({display:"block"})}),$(".question__btn--final").click(function(){var e=$(".test__article--4 input:checked").val(),i=$(".test__article--1 input:checked").val(),t=$(".test__article--2 input:checked").val();$(".question__h1").text(e),"city-1"!=i&&"city-2"!=i||"time1"!=t?"city-1"==i&&"time2"==t||"city-2"==i&&"time2"==t||("city-3"==i||"city-4"==i)&&"time1"==t?($("#question__result-inner-1").text("55 000"),$("#question__result-inner-2").text("30 000")):"city-1"==i&&"time3"==t||"city-2"==i&&"time3"==t||"city-3"==i&&"time2"==t||"city-4"==i&&"time3"==t||"city-5"==i&&"time1"==t?($("#question__result-inner-1").text("75 000"),$("#question__result-inner-2").text("41 000")):"city-3"==i&&"time3"==t||"city-4"==i&&"time3"==t||"city-5"==i&&"time2"==t?($("#question__result-inner-1").text("95 000"),$("#question__result-inner-2").text("51 000")):($("#question__result-inner-1").text("110 000"),$("#question__result-inner-2").text("60 000")):($("#question__result-inner-1").text("35 000"),$("#question__result-inner-2").text("19 000"))})});